    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-950">
        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <nav class="mt-10">
                ...
                <a class="flex items-center px-6 py-2 mt-4 {{ request()->routeIs('kelas.*') ? 'text-white bg-gray-700' : 'text-gray-400 hover:bg-gray-700 hover:text-white' }}"
                   href="{{ route('kelas.index') }}">
                    <i class="fas fa-user-tie mr-3"></i> Kelas
                </a>
                <a class="flex items-center px-6 py-2 mt-4 {{ request()->routeIs('prodi.*') ? 'text-white bg-gray-700' : 'text-gray-400 hover:bg-gray-700 hover:text-white' }}"
                   href="{{ route('prodi.index') }}">
                    <i class="fas fa-user-graduate mr-3"></i> Prodi
                </a>
            </nav>
        </div>
